<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMaster.Master" AutoEventWireup="true" CodeBehind="Yachts_Overview.aspx.cs" Inherits="Yachts.Yatchs_Overview" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="RightContent" runat="server">
    ...
    <div class="right">
        <div class="right1">
            ...
            <div class="box1">
                <asp:Literal ID="lit_overview_content" runat="server"></asp:Literal>
                <br />
                <br />
            </div>
            ...
            <div class="box3">
                ...
                <div style="display: flex">
                    <asp:Literal ID="lit_overview_dime" runat="server"></asp:Literal>
                    <asp:Image ID="img_overview_dimePhoto" runat="server" Width="278" Height="345" />
                </div>
            </div>
            <a href="#top">
                <p class="topbuttom">
            ...
            <div class="downloads">
                ...
                <ul>
                    <asp:Repeater ID="RepeaterOverviewsDL" runat="server" OnItemDataBound="RepeaterOverviewsDL_ItemDataBound">
                        <ItemTemplate>
                            <li>
                                <asp:LinkButton ID="lbtn_overviewsDL_downloadPath" runat="server" CommandArgument='<%# Eval("overviewsDL_downloadPath") %>' OnClick="lbtn_overviewsDL_downloadPath_Click"></asp:LinkButton>
                            </li>
                        </ItemTemplate>
                    </asp:Repeater>
                </ul>
