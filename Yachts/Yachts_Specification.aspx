<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMaster.Master" AutoEventWireup="true" CodeBehind="Yachts_Specification.aspx.cs" Inherits="Yachts.yacht" %>
    ...
    <div class="right">
        <div class="right1">
            ...
            <div class="box5">
                ...
                <asp:Literal ID="lit_spec_content" runat="server"></asp:Literal>
