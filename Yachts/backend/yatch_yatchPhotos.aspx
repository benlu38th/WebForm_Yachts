<%@ Page Title="" Language="C#" MasterPageFile="~/backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="yatch_yatchPhotos.aspx.cs" Inherits="Yachts.backend.yatchPhotos" %>
...
<asp:Content ID="TopAndLeft" ContentPlaceHolderID="TopAndLeft" runat="server">
    <p style="text-align: right; padding-right: 24px; padding-top: 5px; font-size: 13px">
        ...
        >>
        <asp:LinkButton ID="lbtn_goYatchsPhotos" runat="server" Style="font-size: 13px;">遊艇照片集</asp:LinkButton>
    </p>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="display: flex; justify-content: space-around">
        ...
        <asp:Button ID="goYatchPhotos" runat="server" Text="遊艇照片集" class="btn btn-default waves-effect waves-light" OnClick="goYatchPhotos_Click" ForeColor="#00b9f5"/>
    </div>
    <hr />
    <div class="card-block">
        ...
        <label for="exampleSelect1" class="form-control-label" style="display: block">照片清單：</label>
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <div style="display: flex; justify-content: flex-start; align-items: flex-start">
                    <asp:Button ID="deleteImage" runat="server" Text="刪除" class="btn btn-success waves-effect waves-light m-r-1" CommandArgument='<%# Eval("yatchPhoto_id") %>' OnClick="deleteImage_Click" OnClientClick="return confirm('您確定要刪除這個項目嗎？');" />
                    <asp:Image ID="img_yatchPhoto_photoPath" runat="server" ImageUrl='<%# Eval("yatchPhoto_photoPath") %>' />
                </div>
                <br />
            </ItemTemplate>
        </asp:Repeater>
        ...
        <asp:FileUpload ID="ful_yatchPhoto_photoPath" runat="server" />
    </div>
</asp:Content>
